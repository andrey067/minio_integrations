...
builder.Services.AddSwaggerGen(options =>
{
    options.SwaggerDoc(
        ...
        new Microsoft.OpenApi.Models.OpenApiInfo
        {
            ...
            Version = "v1",
            Description =
                "Esta API oferece opera��es de gerenciamento de buckets no MinIO, incluindo cria��o, listagem, exclus�o e upload/download de arquivos.",
                    ...
                    {
                        {
                            "url",
                            new OpenApiString(
                                "https://foforks.com.br/wp-content/uploads/2019/05/news.jpeg"
                            )
                        },
...
app.MapPost(
    "/create-bucket",
    async (IMinioServices minioServices, [FromBody] string bucketName) =>
    {
...
app.MapGet(
    "/list-buckets",
    async (IMinioServices minioServices) =>
    {
...
app.MapDelete(
    ...
    async (IMinioServices minioServices, string bucketName) =>
    {
...
app.MapPost(
        ...
        ) =>
        {
            ...
            await minioServices.UploadFileAsync(
                bucketName,
                file.FileName,
                stream,
                file.ContentType
...
app.MapGet(
    ...
    async (IMinioServices minioServices, string bucketName, string fileName) =>
    {
